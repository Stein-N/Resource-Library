...
import net.xstopho.resourcelibrary.util.AreaUtil;
import net.xstopho.resourcelibrary.util.TreeTrimmingUtil;
    ...
    public abstract static class Axe extends AxeItem {
        ...
        public final boolean canAttackBlock(BlockState state, Level level, BlockPos pos, Player player) {
            ...
            if (level.getBlockState(pos).is(BlockTags.LOGS)) {
                ...
                BlockPos lastPos = new TreeTrimmingUtil().getLastBlock(level, pos);
